...
public class MainActivity extends AppCompatActivity {
    ...
    public static  List<GitHubUser> userDetails;
...
//            this threw an error initially remember to fix it

//            VectorDrawableCompat indicator
//                    = VectorDrawableCompat.create(getResources(), R.drawable.ic_list_black_24dp, getTheme());
//            indicator.setTint(ResourcesCompat.getColor(getResources(),R.color.white,getTheme()));
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new ListContentFragment(), "GitHub Developers");
